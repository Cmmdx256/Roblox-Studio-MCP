...
export class ModelRouter {
    ...
    private manualOverrideModelId?: string;

    constructor(initialProfiles: ModelProfile[] = DEFAULT_MODEL_PROFILES) {
        for (const p of initialProfiles) {
            this.profiles.set(p.id, p);
        }
    }

    public registerProfile(profile: ModelProfile): void {
    ...
    public getAllProfiles(): ModelProfile[] {
        return Array.from(this.profiles.values());
    }

    public setManualOverride(modelId?: string): void {
     ...
     */
    public routeTask(intent: string, hints?: { requiresVision?: boolean; isArchitecturePlanning?: boolean; isSimpleProperty?: boolean }): ModelRoutingDecision {
