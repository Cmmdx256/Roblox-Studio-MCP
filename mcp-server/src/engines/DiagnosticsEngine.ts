...
export class DiagnosticsEngine {
     ...
     */
    public analyzeRobloxError(errorMessage: string, sourceCode?: string): RobloxDiagnosticReport {
     ...
     */
    public async collectDiagnostics(): Promise<{ logs: any[], errors: any[], affectedScripts: string[], recentChanges: any[] }> {
     ...
     */
    public async analyzeRootCause(errorLog: { message: string, traceback?: string }): Promise<{ 
        rootCause: string, 
        confidence: number, 
        offendingScript?: string, 
        line?: number, 
        proposedPatch?: { search: string, replacement: string } 
    }> {
     ...
     */
    public async safeRepair(patchSpec: { 
        scriptPath: string, 
        search: string, 
        replacement: string, 
        dryRun?: boolean 
