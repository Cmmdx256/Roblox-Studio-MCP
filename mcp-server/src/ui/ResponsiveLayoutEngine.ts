...
export class ResponsiveLayoutEngine {
     ...
     */
    public generateResponsiveConstraints(aspectRatio = 1.6, minScale = 0.7, maxScale = 1.3): any[] {
        return [
            {
     ...
     */
    public generateUIAnimationController(): string {
...
`;
    ...
    public getProfile(device: string): DeviceProfile {
