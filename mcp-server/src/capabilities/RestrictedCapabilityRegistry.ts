...
export class RestrictedCapabilityRegistry {
    private descriptors: Map<string, RestrictedCapabilityDescriptor> = new Map();
    ...
    private initializeRegistry(): void {
        const list: RestrictedCapabilityDescriptor[] = [
    ...
    public isRestricted(name: string): boolean {
        return this.descriptors.has(name) || this.descriptors.has(name.replace(/_/g, '.'));
    }

    public getDescriptor(name: string): RestrictedCapabilityDescriptor | undefined {
    ...
    public getAllRestrictedCapabilities(): RestrictedCapabilityDescriptor[] {
        const seen = new Set<string>();
        const unique: RestrictedCapabilityDescriptor[] = [];
    ...
    public getHierarchyTree(): Record<string, RestrictedCapabilityDescriptor[]> {
        const tree: Record<string, RestrictedCapabilityDescriptor[]> = {};
