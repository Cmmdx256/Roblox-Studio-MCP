export const BUILTIN_MECHANIC_CARDS = [
    {
        id: 'kill_brick',
...
export class MechanicCardRegistry {
     ...
     */
    instantiateCard(cardId, customParams = {}) {
        const card = this.cards.get(cardId);
        if (!card)
            throw new Error(`Mechanic card ${cardId} not found`);
        const mergedParams = {};
...
//# sourceMappingURL=MechanicCardRegistry.js.map