...
export declare class DiagnosticsProvider implements IProvider {
    readonly name = "diagnostics-provider";
    readonly type = ProviderType.DIAGNOSTICS;
...
export declare const diagnosticsProvider: DiagnosticsProvider;
