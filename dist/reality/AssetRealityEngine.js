...
export class AssetRealityEngine {
     ...
     */
    async evaluateAsset(instancePath) {
        const evidence = [];
        ...
        const securityStatus = isHighRisk ? 'HIGH_RISK' :
        ...
        const physicsImplications = [];
        const countPhysics = (node) => {
        ...
        const performanceRisk = partCount > 500 || unanchoredCount > 20 ? 'HIGH' :
        ...
        const duplicates = dupes
            ...
            .map(d => d.duplicate);
        const finalStatus = securityStatus === 'HIGH_RISK' ? 'FAILED' :
...
//# sourceMappingURL=AssetRealityEngine.js.map