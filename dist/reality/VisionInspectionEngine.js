...
export class VisionInspectionEngine {
     ...
     */
    inspectGeometric(bounds, viewportWidth, viewportHeight, device = 'Desktop') {
        const defects = [];
        ...
        const status = defects.length === 0 ? 'VERIFIED' : (highSeverityCount > 0 ? 'FAILED' : 'PARTIAL');
        return {
     ...
     */
    async inspectScreenshot(capture) {
...
//# sourceMappingURL=VisionInspectionEngine.js.map