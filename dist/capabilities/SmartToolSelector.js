...
export class SmartToolSelector {
     ...
     */
    selectRelevantTools(prompt, maxTools = 12) {
        const lowerPrompt = prompt.toLowerCase();
        const scoredTools = new Map();
        ...
        if (sorted.length < 4) {
            const baseline = allEntries.filter(e => e.category === 'studio' || e.category === 'instance' || e.category === 'property').slice(0, maxTools);
...
//# sourceMappingURL=SmartToolSelector.js.map